...
type NumaCPUPressureEvictionOptions struct {
	...
	CandidateCount                   int
	WorkloadMetricsLabelKey          string
...
func (o *NumaCPUPressureEvictionOptions) AddFlags(fss *cliflag.NamedFlagSets) {
	...
	fs.StringVar(&o.WorkloadMetricsLabelKey, "numa-cpu-pressure-eviction-workload-metrics-label-key", o.WorkloadMetricsLabelKey,
		"The key of workload metrics label in pod labels")
...
func (o *NumaCPUPressureEvictionOptions) ApplyTo(c *eviction.NumaCPUPressureEvictionConfiguration) error {
	...
	c.WorkloadMetricsLabelKey = o.WorkloadMetricsLabelKey
