...
func NewScorer(emitter metrics.MetricEmitter, evictRules EvictParams, enabledScorers []string) (*Scorer, error) {
...
func (s *Scorer) Score(pods []*CandidatePod) []*CandidatePod {
	...
	for _, key := range s.scorerParams.WorkloadMetricsLabelKeys {
...
func (s *Scorer) SetScorerParam(evictRules EvictParams) {
	s.scorerParams = evictRules
}

func DeploymentEvictionFrequencyScorer(pod *CandidatePod, evictRules EvictParams) int {
...
func UsageGapScorer(pod *CandidatePod, evictRules EvictParams) int {
