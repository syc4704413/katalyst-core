...
type ScoreFunc func(pod *CandidatePod, candidatePodStats EvictRules) int
...
func NewScorer(emitter metrics.MetricEmitter, candidatePodStats EvictRules, enabledScorers []string) (*Scorer, error) {
...
func (s *Scorer) SetScorerParam(candidatePodStats EvictRules) {
...
func DeploymentEvictionFrequencyScorer(pod *CandidatePod, candidatePodStats EvictRules) int {
...
func UsageGapScorer(pod *CandidatePod, candidatePodStats EvictRules) int {
