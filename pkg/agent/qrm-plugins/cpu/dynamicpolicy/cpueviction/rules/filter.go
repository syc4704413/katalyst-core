...
type FilterFunc func(pod *v1.Pod, candidatePodStats EvictRules) bool
...
func NewFilter(emitter metrics.MetricEmitter, candidatePodStats EvictRules, enabledFilters []string) (*Filterer, error) {
...
func (f *Filterer) SetFilterParam(candidatePodStats EvictRules) {
...
func OwnerRefFilter(pod *v1.Pod, candidatePodStats EvictRules) bool {
	if pod == nil {
		return false
	}
...
func OverloadNumaFilter(pod *v1.Pod, candidatePodStats EvictRules) bool {
	if pod == nil {
		return false
	}
