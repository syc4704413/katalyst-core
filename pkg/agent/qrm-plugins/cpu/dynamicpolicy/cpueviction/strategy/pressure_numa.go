...
func NewCPUPressureUsageEviction(emitter metrics.MetricEmitter, metaServer *metaserver.MetaServer,
	...
	general.Infof("numaPressureConfig: %v", numaPressureConfig)
	evictRules := rules.EvictRules{
	...
	general.Infof("numaPressureConfig.EnabledFilters: %v", numaPressureConfig.EnabledFilters)
	...
	general.Infof("numaPressureConfig.EnabledScorers: %v", numaPressureConfig.EnabledScorers)
